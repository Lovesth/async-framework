...
// See: https://github.com/alibaba/async_framework/issues/372
...
#ifndef async_framework_USE_MODULES
#include <cassert>
#include <concepts>
#include <cstddef>
#include <exception>
...
namespace async_framework::coro::detail {
 ...
 * 
 * Allocator support: See async_framework/coro/PromiseAllocator.h
 * 
 * Recursive generator
...
inline constexpr bool
    std::ranges::enable_view<async_framework::coro::Generator<Ref, V, Allocator>> =
        true;
