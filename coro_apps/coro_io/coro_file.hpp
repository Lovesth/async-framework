...
class basic_seq_coro_file {
 public:
  ...
  async_framework::coro::Lazy<std::pair<std::error_code, size_t>> async_read(
  ...
  async_framework::coro::Lazy<std::pair<std::error_code, size_t>> async_read_write(
      std::span<char> buf) {
  ...
  async_framework::coro::Lazy<std::pair<std::error_code, size_t>> async_write(
      std::string_view buf) {
    if constexpr (execute_type == execution_type::thread_pool) {
 ...
 private:
  bool open_stream_file_in_pool(std::string_view filepath,
    ...
    auto coro_func = coro_io::post(
        ...
        &executor_wrapper_);
    auto result = async_framework::coro::syncAwait(coro_func);
    return result.value();
  }
...
class basic_random_coro_file {
 public:
  ...
  async_framework::coro::Lazy<std::pair<std::error_code, size_t>> async_read_at(
  ...
  async_framework::coro::Lazy<std::pair<std::error_code, size_t>> async_write_at(
 ...
 private:
  ...
  async_framework::coro::Lazy<std::pair<std::error_code, size_t>> async_pread(
  ...
  async_framework::coro::Lazy<std::pair<std::error_code, size_t>> async_pwrite(
  ...
  async_framework::coro::Lazy<std::pair<std::error_code, size_t>> async_prw(
